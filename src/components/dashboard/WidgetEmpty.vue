 ...
 *
 * The disc is 56px and the mark inside it 24px. The mark is the tile's OWN chart artwork
...
<template>
  <div class="we" :class="{ err: kind === 'error' }">
    ...
    <b class="we-title">{{ state.title }}</b>
    <span class="we-sub">{{ state.sub }}</span>
    <button
...
/* 56px disc, 24px mark. A circle rather than the 4px rounded square this started as —
...
.we-title { color: var(--ink-2); font-size: 13px; font-weight: 600; }
